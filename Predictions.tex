...
We present fifteen predictions spanning gauge couplings, quark mixing, lepton masses, neutrino mixing, the Higgs mass, and the bottom-to-tau mass ratio. Thirteen are purely geometric; two involve non-perturbative lattice dynamics at $\beta = 11.1$.
...
The quark sector has $Q_{\text{down}} = 0.731 \neq 2/3$. The deviation matches $Q_{\text{down}} \approx (2/3)(1 + \alpha_s/\pi)$ to $0.15\%$: SU(3) color breaks the $\mathbb{Z}_3$ symmetry.
