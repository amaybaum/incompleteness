...
\end{equation}
The observed $2.352$ requires $Z_S = 1.82$ at $m_{\text{match}} \approx 0.12$. The completed $L = 32$ run (50 configs) gives $Z_S(0.120) = 1.821 \pm 0.001$, yielding $m_b/m_\tau = 2.350$ --- matching observation to $0.1\%$. The $\pm 0.15$ is from the undetermined matching mass; statistics and volume effects are each $< 0.1\%$.
