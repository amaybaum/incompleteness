...
- *Non-perturbative structural features.* $\bar\theta = 0$ at the kinematic level of the lattice construction, a conditional structural constraint ([SM §5], scoped at [SM §5.5]); instanton-sum closure consistent with $T$-invariance and detailed balance.
