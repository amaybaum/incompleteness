...
The structural investigation of OI's no-GUT prediction (developed in [SM §6.7] and [SM §8.7]) surfaced several substantive open questions that bear on the framework's predictive content but require further work to develop. We catalog them here as flagged research directions; their development is deferred to future work.
