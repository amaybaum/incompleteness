...
| §3.2: Bell analysis | Spatial OI supplies causal cones; quantum CHSH requires setting screening + indivisibility | causal-local class $\Rightarrow S_{\rm CHSH}\le 2\sqrt2$; bare OI has PR negative control |
