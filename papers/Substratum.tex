...
the C1--C4 observer-selection theorem of {[}Main, §4.6{]}, answering the
...
structure produces QM. A referee skeptical of ETH may therefore read the
...
measurement arrows from a single structural clock and the C1--C4
