...
itemization is under review: whether the observer's embeddedness --- the
proper-part decomposition \(V \subsetneq S\) --- is a lemma of the first
axiom or a third axiom in its own right. The question turns on the
reading of the primitive and is presentational, not empirical; the
two-axiom count is used here as the working presentation pending its
resolution.)
