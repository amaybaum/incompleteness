...
minimal --- finite --- representative of the equivalence class. The
substrate's total cardinality beyond the boundary layer is not an
observable question, in the same sense that the uniform vacuum offset is
not.)
