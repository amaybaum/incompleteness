...
embedded-observation theorem: under four structural conditions (C1:
non-trivial coupling, C2: slow bath, C3: high-capacity hidden sector,
C4: history readback), the embedded observer's description is
necessarily non-Markovian --- and quantum mechanics for processes in the
...
the four structural conditions C1 (non-trivial coupling), C2 (slow
bath), C3 (high-capacity hidden sector), and C4 (history readback), the
