...
established operationally by the twenty-two parameter-free retrodictions
of {[}SM §7{]} (Remark on finite observation sets below), not by the
Standard Model precision record itself. The precision record is
...
\item
  ...
  GW250114 confirms the classical area theorem, which the framework
  preserves; the \(1/4\) coefficient has no direct empirical test.
\item
