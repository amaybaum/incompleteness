...
discrete residue} --- dimension, internal-component count,
multiplicities, gauge group, generation count, hypercharges,
\(\bar\theta=0\) --- relative to those inputs, rather than deriving them
from the bare fact of observation; the precise sense in which this
residue is forced (and the sense in which the lattice itself is
empirically selected) is set out in the substantive-content Remark of §3
and in the three-tier classification of {[}SM §8.3{]}.
