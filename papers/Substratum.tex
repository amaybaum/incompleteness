...
the wave function, Born rule, and unitary evolution arising as derived
rather than fundamental constructs. The projection from the same
...
the four conditions C1 (non-trivial coupling), C2 (memory persistence),
C3 (high-capacity hidden sector), and C4 (history readback), the
embedded observer's compressed description is necessarily non-Markovian
--- quantum mechanical for processes in the correspondence's class under
(T) --- with the conditions both necessary and sufficient per finite
horizon (the C2-necessity step conditional on the hidden-sector mixing
