...
\item
  ...
  \(\bar\theta = 0\) at the kinematic level of the construction
  (Theorems 17--21; an unsupported result, scoped at {[}SM, §5.5{]}).
\end{enumerate}
...
unsupported per {[}SM, §5.5{]}). Twenty-two quantitative predictions
...
\item
  ...
  21), though the result is unsupported per SM §5.5; any observation of
  a non-zero neutron electric dipole moment consistent with
