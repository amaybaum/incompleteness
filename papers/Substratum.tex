...
necessarily non-Markovian --- and quantum mechanics for the
P-indivisible subclass, under the translation hypothesis (T) --- with
...
--- quantum mechanical for the P-indivisible subclass under (T) --- with
the conditions both necessary and sufficient per finite horizon (the
