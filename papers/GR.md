...
**Magnitude at theorem level.** The self-consistent emergent-QFT calculation gives the $H^2$ coefficient directly. In OI the matter fields and the curved-spacetime background are both emergent from the classical discrete substratum; the Shapiro-Solà β-function formula [33, 34] for the vacuum-energy running coefficient
