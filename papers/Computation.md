...
### 7.2 Task-specific quantum advantage, hidden group structure, and the $\mathrm{SU}(2)$-compatibility refinement
...
- task-specific quantum-advantage structure correlating with problem globality (§7.2).
...
[12] G. Kuperberg, "A subexponential-time quantum algorithm for the dihedral hidden subgroup problem," *SIAM J. Comput.* **35**, 170 (2005); arXiv:quant-ph/0302112.
