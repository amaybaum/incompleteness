...
- Under the explicit computational model of §4, BQP is the computational class accessible to embedded observers satisfying C1–C3 (conditional BQP model theorem, §4; extended development in [1, Ch. 14]).
