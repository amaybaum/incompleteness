...
from gene-expression data alone is memory-bearing --- accessibly
non-Markovian, with P-indivisibility the stronger diagnostic requiring a
measured witness (\texttt{review4\_probes.py}): the marginal dynamics on
the gene-expression subspace cannot be described by a Markovian kinetic
equation, and methods assuming such description will produce biased
estimates.
