/*
 * vertex_T1b_chunked.c — Chunked version of T1b vertex correction for large-N batch.
 *
 * Same as vertex_T1b.c but takes (chunk_idx, num_chunks) and only
 ...
 *
 * Usage:
 *   ./vertex_T1b_chunked N m_reg p0 chunk_idx num_chunks [threads]
 *
 * Example for N=12 split into 4 chunks:
 *   ./vertex_T1b_chunked 12 0.2 0.5236 0 4   # chunk 0
 *   ./vertex_T1b_chunked 12 0.2 0.5236 1 4   # chunk 1
 *   ./vertex_T1b_chunked 12 0.2 0.5236 2 4   # chunk 2
 *   ./vertex_T1b_chunked 12 0.2 0.5236 3 4   # chunk 3
 * Sum the 4 outputs, multiply by 0.5 / N^8.
 *
 * Compile: gcc -O3 -fopenmp -ffast-math -march=native vertex_T1b_chunked.c -o vertex_T1b_chunked -lm
 */
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
...
int main(int argc, char **argv) {
    ...
    /* k_2-independent precomputations (same as full version: pre-build U[k1] and prop_k1) */
