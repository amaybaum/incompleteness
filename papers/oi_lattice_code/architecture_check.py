...
INVARIANTS = [
    ...
    (r"slow-bath memory|slow-bath timescale separation|slow \(C2|C3 \(high|C3: \$?N_H|C3 requires large hidden-sector capacity|high-capacity \(C3",
    ...
    (r"C1–C4 ⇒ QM|necessarily experiences P-indivisible|hence imply the stochastic process is P-indivisible|necessarily non-Markovian whenever",
     "no C1–C4 ⇒ QM, no C4 ⇒ P-indivisibility, no generic Bell ⇒ temporal P-indivisibility (review4_probes.py; b165)",
     [],
     "the *sufficiency* direction (C1–C4 ⇒ QM) is unconditional"),
    (r"generates (emergent )?(QM|quantum mechanics)|whose cost is quantum mechanics|how quantum mechanics emerges at all",
