...
# Exit 0 iff all thirty suites and all three guards pass. (b63; named in the seventh-review triage.)
set -u
...
[ $FAIL -eq 0 ] && echo "all thirty suites green (+ citation, architecture and mirror guards)" || echo "BATTERY FAILED"
exit $FAIL
