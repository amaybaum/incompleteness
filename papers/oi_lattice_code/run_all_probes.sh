...
# Exit 0 iff all twenty-six suites and both guards pass. (b63; named in the seventh-review triage.)
set -u
...
[ $FAIL -eq 0 ] && echo "all twenty-six suites green (+ citation, architecture and mirror guards)" || echo "BATTERY FAILED"
exit $FAIL
