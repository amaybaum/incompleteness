...
SU(2) produces a parity-violating energy difference whose sign is fixed
by the partition. The viable fraction of the 18-dimensional parameter
space is estimated at \textasciitilde16\%.
...
and Darwinian evolution --- closing with a forward-pointer to the
companion paper {[}38{]} that continues the chain through general
intelligence, AI, and the BQP characterization for embedded observers.
§6 addresses the existence question. §7 applies C1--C3 to biological
systems, predicting non-Markovian enzyme kinetics with implications for
drug design. §8 identifies where OI corrections reach engineering
relevance --- quantum computing, quantum sensing, and precision
metrology --- and proposes three engineering frontiers: engineered
partitions (the bath as programmable memory), non-Markovian quantum
computation (P-indivisible gate sequences), and quantum materials with
designed C1--C3 architectures.
...
window, chirality --- is invariant under the generators of
