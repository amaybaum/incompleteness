...
The same C1--C4 conditions that produce QM cosmologically are satisfied
in proteins (\(\tau_S / \tau_B \sim 10^{-9}\) to \(10^{-12}\)),
predicting non-Markovian enzyme kinetics consistent with single-molecule
