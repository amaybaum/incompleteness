...
selectivity of the SU(2) embedding --- hypothesis H-χ, stated as open in
{[}2, §4.8{]}. The observed electroweak sector realizes it: the W
...
hypothesis H-χ {[}2, §4.8{]}, so the sign is inherited from the observed
electroweak sector rather than derived from the partition.
...
result; whether it is \emph{uniquely traceable} to (S, φ) depends on H-χ
and on which amplification mechanism actually operated in Earth's
prebiotic chemistry.
