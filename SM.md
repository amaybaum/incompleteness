...
This subsection's content is *implicit* in the framework's existing derivations (§4.7's link-carrier structure plus §6.1's bilinear induced-coupling structure plus §5's T-invariance treatment) but had not previously been articulated as a unified mapping. The unified mapping clarifies which conservation laws are exact at which level and how the framework accommodates the SM's full non-perturbative structure.
