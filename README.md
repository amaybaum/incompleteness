...
(S, φ) — a finite lossless memory with bounded coupling and statistical isotropy
  ...
  ├─→ Mass chain: m_s → m_d, m_u, m_b, m_τ, m_e, m_μ (6 masses, all within ~1.3%) (SM §7)
  ...
  ├─→ m_b/m_τ = 4.28/Z_S(λg₀²) = 2.36 (observed 2.352; 0.4% at L=32, ~1–2% systematic) (SM §7)
