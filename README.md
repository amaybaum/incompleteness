...
- **[`Main`](papers/Main.md)** — establishes QM as the necessary description of an embedded observer of a deterministic substrate. P-indivisibility theorem, stochastic-quantum correspondence, characterization theorem, Bell violations. ([`.tex`](papers/Main.tex), [`.pdf`](papers/Main.pdf))
