...
- **[`SM`](papers/SM.md)** — derives the Standard Model from a $d=3$ cubic lattice. SU(3)×SU(2)×U(1); threefold taste multiplicity (candidate generations under H-spin, chirality under H-χ', sharpened: the minimal embedding is certified vector-like); $\bar\theta=0$ within the construction; twenty-two quantitative observables. ([`.tex`](papers/SM.tex), [`.pdf`](papers/SM.pdf))
