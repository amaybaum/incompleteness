...
Combined with the earlier papers' predictions — dark energy evolution with $\nu_{\text{OI}} = (2.45 \pm 0.04) \times 10^{-3}$, gravitational wave echoes, dark matter evolving with $H(z)$, and gauge couplings at $M_Z$ — the framework makes a suite of falsifiable predictions that no competing theory makes jointly.
