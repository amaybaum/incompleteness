...
This is not a prediction awaiting future data. The observed vacuum energy has been measured since 1998, and it sits exactly at the classical geometric scale — the value the framework expects. Five decades of searching for a cancellation mechanism within quantum-first frameworks have found nothing. The framework explains why: there is nothing to cancel.
...
These qualitative predictions — invisible gravity, onset at acceleration scales below $cH$, cosmologically evolving acceleration scale — are derived entirely from the framework's axioms. The quantitative force law governing these effects requires additional input beyond the axioms and is deferred to future work.
