...
Determination for `verification/OI-ROOTED-CLASSIFICATION-AUDIT.md`, frozen at commit
...
`verification/C4-CAUSAL-READBACK-AUDIT-AMENDMENT-1.md`, append-only, with the frozen C4 audit left
