...
This programme sits under §8 of `verification/OI-QM-RESEARCH-PROGRAMME.md`: it neither advances nor blocks the OI → QM equivalence/classification chain unless an explicit theorem later connects the two. Conversely, OI → QM results may not be imported here as evidence without a proved bridge.
