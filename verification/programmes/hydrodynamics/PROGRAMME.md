...
Status base: `main` at `ae81459372887cfbe27b427b30bbdad1b564f2b7` (post-PR #595, round H-A's control plane merged; round H-A executed on that base, `round-h-a-source-audit/result.md`).
