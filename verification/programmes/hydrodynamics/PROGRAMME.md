...
Status base: `main` at `8de0478ef31fe4cabcf89fc5787f80f38376a957` (post-PR #601, round H-B's control plane merged; round H-B executed on that base, `round-h-b-reversible-fluid-substratum/result.md`).
