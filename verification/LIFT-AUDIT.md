...
## The flow endpoint on the sourced baseline, recorded after the round

`FLOW-ENDPOINT-AUDIT.md` and `OIBridge/FlowEndpoint.lean` decide the arrow from the sourced
baseline: `SourcedOI ∧ LayerFlowExecutable ⇏ PhaseFreeRichness`, by the theory generated by the
ones-fixing class of the instrument-realization audit, which satisfies `SourcedOI`, executes every
