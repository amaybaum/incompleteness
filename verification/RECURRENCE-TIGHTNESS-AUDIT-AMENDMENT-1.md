...
This is an **append-only preregistration amendment** to `verification/RECURRENCE-TIGHTNESS-AUDIT.md`. It is committed and frozen before any proof search, candidate full-period realization search, brute-force search, new simulation, or execution of the declared tightness construction.
