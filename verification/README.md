...
therefore lies in the stated access (`permData_U_permClass`), whence the theory generated by its own
operator content has no quarter phase at two or more states (`arcCWitness_not_phasesAvailable`).
