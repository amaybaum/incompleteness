...
| manuscript axioms A1–A6 | 1 | kernel-only | no manuscript occurrence: A1 and A2 hold for the witness and for quantum mechanics under their faithful theory-level forms, A3–A6 are formalization gaps with the missing interface recorded, and the configuration-level sourcing bound places every configuration-level sourcing inside the witness; nothing is asserted about the witness against A3–A6 or about the strongest OI ⇒ QM claim |
