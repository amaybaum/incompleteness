...
`arcCWitness_not_phasesAvailable`: composing with the merged invariant, the theory generated by the
Arc C witness's own operator content has no quarter phase at any level with two or more states.
