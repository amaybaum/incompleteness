...
`B = 39090ca75860e7e6cbd99fa6f3ad859cee3efaf4`. **The first recorded execution act was the
...
The base moved a second time under Amendment 2,
`verification/infrastructure/round-gr-1-roadmap-entry-scoping/amendments/amendment-2.md`, blob
`d7a50c458dea5c35660c9bfc7b7fe47b923396a1`, which corrected the landing's pin loop after the
second attempt reached a certified head `5e59122e1a7f92f20a6115f8c417b865efb8382c` under
chronology `EXECUTION` and then, at its candidate landing
`73f505974674e76b1bb425bc9f605ed5feab3a0f`, could not complete: the loop's name extraction was
undefined for the pinned repository-root path and its keys were not injective over the pinned
paths. Both objects are history, neither is this round's `E`, and neither is ancestry of it.
...
| --- | --- | --- |
| `GR1-1` | `b9ca55011ffd75f2e3bb6140988d7dd79fd170c8` | 92 of 92 pre-existing tags PASS, `R7-PFR` included; no `R7-GR1` |
| `GR1-2` | `d0c8a8e19bb6cf535a91c7fcac064c36c4bb1482` | 93 tags: the 92 pre-existing all PASS and identical to the stage-1 verdicts; `R7-GR1` the sole failure |
...
run at `d0c8a8e19bb6cf535a91c7fcac064c36c4bb1482`, taken verbatim from that run and neither
...
That single base run took **169 seconds**. It is taken once and persisted; this clause does
