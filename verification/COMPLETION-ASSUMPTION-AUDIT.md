...
well-formedness. The second, the minimal elementary repertoire, is settled by
...
drive with one cycle alone does not suffice on even carriers (`not_hControl_evenCycle`). The other
two are open; nothing in this note
settles them.
