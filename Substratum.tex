...
\fi
% \usepackage{lmodern} % removed (xelatex uses fontspec)
\ifPDFTeX\else
...
energy in Type II running-vacuum form with coefficient
\(|\nu| \sim 10^{-4}\) and negative sign, consistent with the Bertini et
al.~(2025) direct DESI-DR2-era fit at better than \(1\sigma\); a
...
II RVM dark energy with \(|\nu| \sim 10^{-4}\) and negative sign, MOND
