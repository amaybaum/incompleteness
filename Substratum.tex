...
\item
  ...
  mechanism producing the square root (Direction 11; structurally
  analogous to D10 in being mixed-layer --- substratum cubic-group
...
\item
  ...
  that share the SχPT machinery. Closure path is Direction 10 --- the
  two-loop SχPT calculation specializing Panagopoulos--Spanoudes 2017 to
  the OI cubic-group setting.
\item
