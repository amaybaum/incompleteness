...
chiral generations, anomaly-free hypercharges, and \(\bar\theta = 0\) as
forced retrodictions; and (ii) the \emph{substratum gauge group}
...
three SM gauge couplings at \(M_Z\) via a one-parameter consistency test
({[}SM, §6.3{]}).
...
\([(S, \varphi)]/\mathcal{G}_{\text{sub}}\) at the lattice level, with
the Standard Model gauge group, three chiral generations, anomaly-free
hypercharges, and \(\bar\theta = 0\) as forced retrodictions. The
substratum gauge group identifies the kernel of this inverse map and
shows that the Standard Model gauge group is its visible-sector shadow.
Together, these two results establish that the framework's emergence of
quantum mechanics {[}Main{]}, its derivation of the Standard Model
{[}SM{]}, and its derivation of the gravitational sector {[}GR{]} are
not three independent applications of the same trace-out machinery but
three projections of one object --- the bijection \((S, \varphi)\) ---
viewed at different levels of description.
