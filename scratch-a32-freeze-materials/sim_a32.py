...
kind = sys.argv[1]
WT = os.path.join(S, 'wt-sim32-' + kind)
...
vec = {'notrigid': 'A32-NOT-RIGID', 'rigid': 'A32-RIGID', 'undecided': 'A32-UNDECIDED'}[kind]
...
sh('python3', 'tools/v3_receipt.py', '--status', 'complete', '--d', D, '--f', F, '--e', E,
   ...
   '--attest', 'check-run', 'E', P + '/actions/runs/2', '--out', 'verification/receipts/A32.json')
