...
\subsection{The Minimal Structure}\label{the-minimal-structure}}

\hypertarget{what-the-theorems-require}{%
\subsubsection{What the theorems require}\label{what-the-theorems-require}}
...
\subsubsection{What the theorems do not require}\label{what-the-theorems-do-not-require}}
...
\subsubsection{The minimal object}\label{the-minimal-object}}
...
\subsection{The Coupling Graph}\label{the-coupling-graph}}

\hypertarget{definition-and-the-factorization-problem}{%
\subsubsection{Definition and the factorization problem}\label{definition-and-the-factorization-problem}}
...
\subsubsection{Space as coupling structure}\label{space-as-coupling-structure}}
...
\subsubsection{The dissolution of the container problem}\label{the-dissolution-of-the-container-problem}}
...
\subsection{The Alphabet as Gauge Freedom}\label{the-alphabet-as-gauge-freedom}}
...
\subsection{Background Independence}\label{background-independence}}
...
\hypertarget{why-d-3}{%
\subsection{Why d = 3}\label{why-d-3}}
...
\subsection{The Emergent Quantum Field Theory}\label{the-emergent-quantum-field-theory}}
...
\subsubsection{The wave equation as lattice Klein-Gordon}\label{the-wave-equation-as-lattice-klein-gordon}}
...
\subsubsection{Factorization into Dirac operators}\label{factorization-into-dirac-operators}}
...
\subsubsection{Center independence and chiral symmetry}\label{center-independence-and-chiral-symmetry}}
...
\subsubsection{Multi-component dynamics and gauge structure}\label{multi-component-dynamics-and-gauge-structure}}
...
\subsubsection{K = 2d from coupling-degree minimization}\label{k-2d-from-coupling-degree-minimization}}
...
\subsubsection{Cubic decomposition: multiplicities (3, 2, 1)}\label{cubic-decomposition-multiplicities-3-2-1}}
...
\subsubsection{Staggered species, generations, and the Higgs}\label{staggered-species-generations-and-the-higgs}}
...
\subsubsection{Chirality from the trace-out}\label{chirality-from-the-trace-out}}
...
\subsubsection{Anomaly cancellation and hypercharges}\label{anomaly-cancellation-and-hypercharges}}
...
\subsubsection{Renormalizability}\label{renormalizability}}
...
\subsubsection{Spontaneous symmetry breaking and the hierarchy}\label{spontaneous-symmetry-breaking-and-the-hierarchy}}
...
\subsubsection{The filter chain}\label{the-filter-chain}}
...
\subsection{The Strong CP Problem}\label{the-strong-cp-problem}}

\hypertarget{t-invariance-of-the-wave-equation}{%
\subsubsection{T-invariance of the wave equation}\label{t-invariance-of-the-wave-equation}}
...
\hypertarget{ux3b8-0}{%
\subsubsection{θ = 0}\label{ux3b8-0}}
...
\subsubsection{Detailed balance and θ̄ = 0}\label{detailed-balance-and-ux3b8-0}}
...
\subsubsection{The measurement problem}\label{the-measurement-problem}}
...
\subsubsection{Observer genericity}\label{observer-genericity}}
...
\subsubsection{Relation to other approaches}\label{relation-to-other-approaches}}
...
\subsubsection{What the framework determines and what the specific bijection determines}\label{what-the-framework-determines-and-what-the-specific-bijection-determines}}
...
\subsection{Synthesis: The Complete Program}\label{synthesis-the-complete-program}}

\hypertarget{the-starting-point}{%
\subsubsection{The starting point}\label{the-starting-point}}
...
\subsubsection{The general theorem {[}1{]}}\label{the-general-theorem-1}}

Under these axioms and conditions, the visible-sector reduced dynamics is P-indivisible, equivalent to unitary quantum mechanics. The conditions are necessary and sufficient. Applied to the cosmological horizon: the gap equation ℏ = c³ε²/(4G), the Bekenstein-Hawking formula with the 1/4 factor, dissolution of the 10¹²² CC discrepancy, and dark sector concordance (\textasciitilde95\% of ρ\_crit invisible to the emergent QFT). Falsifiable predictions: dark energy evolution and GW echoes.

\hypertarget{the-rigidity-test}{%
\subsubsection{The rigidity test}\label{the-rigidity-test}}
...
\subsubsection{The structural foundations and emergent SM {[}this paper{]}}\label{the-structural-foundations-and-emergent-sm-this-paper}}
...
\subsubsection{The physical interpretation of (S, φ)}\label{the-physical-interpretation-of-s-ux3c6}}
...
\subsubsection{The reconstruction theorem}\label{the-reconstruction-theorem}}
