...
The concordance is non-trivial. The axioms were formulated to address embedded observation, not cosmological composition. That they produce a gravitational budget matching the observed dark sector is independent corroboration that observational incompleteness is capturing real physical structure.
...
**The dark sector as corroboration (Part III).** The trace-out that produces quantum mechanics simultaneously renders ~95% of the universe's gravitational budget invisible to the emergent QFT: the boundary entropy has effective energy density $\rho_{\text{crit}}$, no QFT operator, and matter-induced displacements that persist through P-indivisibility. This matches the observed dark sector without additional assumptions. That axioms formulated to address embedded observation also account for the universe's gravitational composition provides independent corroboration that observational incompleteness is capturing real physical structure.
