...
another. Each exists because a real defect shipped past the others:
  ...
  v3-receipts          the V3 verdict, from round V3-11: every receipt in the
                       ...
                       the commit that last wrote it, and, from round V3-14, the
...
def main():
    ...
    checks = [
        ...
        # legacy-records: the records of the rounds landed before V3 (round V3-14). Every record the
        ...
        # v3-self-test and v3-corpus: the verifier's own regression evidence (round V3-14), kept
        ...
        # record unchanged since then (round V3-14); a receipt that does not hold, or a
