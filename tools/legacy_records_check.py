#!/usr/bin/env python3
"""legacy_records_check.py -- the records of the rounds landed before V3 are immutable (round V3-14).
...
each a path and a blob. At the commit named, read from git objects and nothing else:
  ...
  provenance  the manifest's blob is INITIAL, the population round V3-12 measured and round V3-14
