...
with the $\Lambda$CDM limit at the $2\sigma$ boundary of the posterior. This agrees with the qualitative prediction above in both sign and order of magnitude at better than $1\sigma$. An earlier pre-DESI canonical RVM fit by Gómez-Valent and Solà [16] returned $\nu = (1.34 \pm 0.38) \times 10^{-3}$ with $3.5\sigma$ preference over $\Lambda$CDM — positive sign and an order larger in magnitude; the migration from this value to Bertini's as the data improved from pre-DESI to DESI DR2 is itself informative. DESI Year 5 ($\sim 1\%$ precision on $\nu$) provides the decisive test: the framework predicts $|\nu|$ of order $10^{-4}$ with negative sign, falsifiable at $> 3\sigma$ by either $\nu > +1.5 \times 10^{-4}$ or $|\nu| > 10^{-3}$.
...
| Dark energy coefficient (structural) | $|\nu| \sim 10^{-4}$, sign negative (Type II RVM) | Bertini 2025 fit to DESI DR2 + DES-Y5 + Planck | consistent at $< 1\sigma$ |
...
The prediction of Type II running-vacuum dark energy with $|\nu| \sim 10^{-4}$ and negative sign is the gravitational sector's most distinctive output: the structural form is forced by boundary-entropy architecture (§7.1), the sign follows from the direction in which the matter-induced structured fraction of boundary entropy evolves with cosmic time, and the magnitude follows from the framework-internal combination $\Omega_B/\mathcal{N}_0 \sim 3 \times 10^{-4}$ on a dimensional argument. The prediction agrees with the Bertini et al. (2025) direct RG-corrected $\Lambda$CDM fit to DESI DR2 + DES-Y5 + Planck 2018 [15] at better than $1\sigma$ in both sign and order of magnitude. The falsification path is explicit: DESI Year 5 returning $\nu > +1.5 \times 10^{-4}$ or $|\nu| > 10^{-3}$ at high confidence would rule out the framework's Type II RVM prediction and falsify Part II as a gravitational theory. A full first-principles derivation of the magnitude — upgrading the dimensional argument to a theorem — requires completing the dark-energy / dark-matter split analysis of §7.3 and is flagged as an open technical item.
