...
The four generators of \(\mathcal{G}_{\text{sub}}\) {[}33, Theorem 24{]}
make this precise: all four preserve observables, and the reconstruction
theorem establishes that any two substrata consistent with the observed
physics and the framework's structural assumptions lie in the same
equivalence class under their composition. The structural preconditions
for complexity are therefore as immutable as the gauge group itself ---
they are not drawn from an ensemble but fixed by the equivalence class.
