...
**Lemma B.7.3 (P-indivisibility from a non-permutation one-step matrix).** *Under conditions C1 (non-trivial coupling), C2 (slow hidden sector), and C3 (large hidden-sector capacity), the emergent stochastic dynamics on the visible sector is P-indivisible.*
