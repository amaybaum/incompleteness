...
§B.2, the hidden output depends on the visible input only through $\partial^{-}R$, and the
...
the abelian condition itself is proved above for the update of §B.2. The extension to
