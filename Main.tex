...
\textbf{Tier 2 (Part II, given the cosmological realization).} The gap equation \(\hbar = c^3 \epsilon^2 / (4G)\) (§5.2), the Bekenstein-Hawking entropy with the \(1/4\) factor (§6), and the CC dissolution identifying \(10^{122}\) as \(S_{\text{dS}}\) (§7). These require accepting that the cosmological horizon satisfies C1--C3, verified in §4.2.

\textbf{Tier 3 (consistency checks and parametric predictions).} The dark-sector concordance (\textasciitilde95\% of \(\rho_{\text{crit}}\), §8.3), the dark energy parameter \(\nu_{\text{OI}}\) (§8.1), and the GW echo timescale (§8.2). These are derived consequences, not independent derivations; they would be falsified by observation but do not carry the same deductive weight as Tiers 1--2.
