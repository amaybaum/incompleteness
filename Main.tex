...
\author{Alex Maybaum}
\date{March 2026 --- DRAFT PRE-PRINT}
...
\subsubsection{The Problem of Embedded Observation}\label{the-problem-of-embedded-observation}}
...
\subsubsection{Conditions on the Hidden Sector}\label{conditions-on-the-hidden-sector}}
...
\subsubsection{Partition-Relativity}\label{partition-relativity}}
...
\subsection{EMERGENT STOCHASTICITY AND P-INDIVISIBILITY}\label{emergent-stochasticity-and-p-indivisibility}}

\hypertarget{emergent-stochasticity}{%
\subsubsection{Emergent Stochasticity}\label{emergent-stochasticity}}
...
\subsubsection{The Slow-Bath Regime}\label{the-slow-bath-regime}}
...
\subsubsection{P-Indivisibility}\label{p-indivisibility}}
...
\subsubsection{Explicit Construction: A Minimal Model}\label{explicit-construction-a-minimal-model}}
...
\subsection{THE EMERGENCE OF QUANTUM MECHANICS}\label{the-emergence-of-quantum-mechanics}}

\hypertarget{the-stochastic-quantum-correspondence}{%
\subsubsection{The Stochastic-Quantum Correspondence}\label{the-stochastic-quantum-correspondence}}
...
\subsubsection{Bell Inequality Violations}\label{bell-inequality-violations}}
...
\subsubsection{The Characterization Theorem: Necessity of the Conditions}\label{the-characterization-theorem-necessity-of-the-conditions}}
...
\subsection{THE COSMOLOGICAL HORIZON AS CAUSAL PARTITION}\label{the-cosmological-horizon-as-causal-partition}}
...
\subsubsection{Verification of the Conditions}\label{verification-of-the-conditions}}
...
\subsection{\texorpdfstring{DERIVATION OF THE EMERGENT ACTION SCALE (\(\hbar\))}{DERIVATION OF THE EMERGENT ACTION SCALE (\textbackslash hbar)}}\label{derivation-of-the-emergent-action-scale-hbar}}

\hypertarget{the-classical-horizon-temperature}{%
\subsubsection{The Classical Horizon Temperature}\label{the-classical-horizon-temperature}}
...
\subsubsection{The Emergent Action Scale}\label{the-emergent-action-scale}}
...
\subsubsection{Gauge-Fixing and the Dimensional Obstruction}\label{gauge-fixing-and-the-dimensional-obstruction}}
...
\subsection{SELF-CONSISTENCY AND THE DISCRETENESS SCALE}\label{self-consistency-and-the-discreteness-scale}}
...
\subsection{DISSOLUTION OF THE COSMOLOGICAL CONSTANT PROBLEM}\label{dissolution-of-the-cosmological-constant-problem}}

\hypertarget{the-two-levels-of-description}{%
\subsubsection{The Two Levels of Description}\label{the-two-levels-of-description}}
...
\subsubsection{Why Gravity Sees the Classical Value}\label{why-gravity-sees-the-classical-value}}
...
\subsubsection{\texorpdfstring{The Structural Origin of the \(10^{122}\) Discrepancy}{The Structural Origin of the 10\^{}\{122\} Discrepancy}}\label{the-structural-origin-of-the-10122-discrepancy}}
...
\subsection{PREDICTIONS AND TESTS}\label{predictions-and-tests}}

\hypertarget{dark-energy-evolution-in-running-vacuum-form}{%
\subsubsection{Dark Energy Evolution in Running Vacuum Form}\label{dark-energy-evolution-in-running-vacuum-form}}
...
\subsubsection{Gravitational Wave Echoes}\label{gravitational-wave-echoes}}
...
\subsubsection{The Dark-Sector Corollary}\label{the-dark-sector-corollary}}
...
\subsubsection{Interpretive Consequences}\label{interpretive-consequences}}
...
\subsubsection{The Stochastic-Quantum Bridge}\label{the-stochastic-quantum-bridge}}
...
\subsubsection{The Status of the Discreteness Scale}\label{the-status-of-the-discreteness-scale}}
...
\subsubsection{Vacuum Energy: Relative Effects and the Higgs Potential}\label{vacuum-energy-relative-effects-and-the-higgs-potential}}
...
\subsubsection{Relation to Prior Work}\label{relation-to-prior-work}}
...
\subsubsection{Assumptions, Limitations, and Falsifiability}\label{assumptions-limitations-and-falsifiability}}
...
\textbf{Open problems.} The framework does not address the regime of nested or overlapping partitions (e.g., a black hole horizon inside the cosmological horizon), where two partition boundaries with different geometries coexist. §8.2 treats the specific case of GW echoes; the general theory requires further development. Laboratory tests of the characterization theorem may be possible in analogue gravity systems where the hidden sector capacity is tunable.
