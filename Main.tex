...
\hypertarget{b.3-quantum-consistency}{%
\subsubsection{B.3 Quantum Consistency}\label{b.3-quantum-consistency}}
...
\emph{Proof.} By the Stinespring construction (Appendix A), the bijection \(\varphi\) on \(\mathcal{C}_V \times \mathcal{C}_B \times \mathcal{C}_D\) defines a unitary \(U_\varphi\) on \(\mathcal{H} = \mathcal{H}_V \otimes \mathcal{H}_B \otimes \mathcal{H}_D\), where \(\mathcal{H}_V = \mathbb{C}^{|\mathcal{C}_V|}\), \(\mathcal{H}_B = \mathbb{C}^{|\mathcal{C}_B|}\), \(\mathcal{H}_D = \mathbb{C}^{|\mathcal{C}_D|}\).
...
\hypertarget{b.5-correction-structure}{%
\subsubsection{B.5 Correction Structure}\label{b.5-correction-structure}}
...
\item
  \emph{Monotonicity.} The CPTP channel \(\Phi_V\) (the emergent dynamics) is a contraction of relative entropy {[}33, Theorem 11.9{]}: for any two states \(\rho, \sigma\),
\end{enumerate}
