...
\small\textit{DRAFT PRE-PRINT} \quad|\quad \textit{Theoretical Physics / Foundations}}
...
\begin{equation}
    \rho_{\text{grav}} = \frac{\Lambda\,c^2}{8\pi G} \sim 6\times10^{-10}\;\text{J/m}^3
\end{equation}
...
Let the full state space be partitioned into degrees of freedom accessible to observers (the \emph{visible sector}) and degrees of freedom that are not (the \emph{hidden sector}, denoted $\Phi$). The projection discarding the hidden sector is many-to-one. \textbf{There exist properties of the universe that no observer confined to the visible sector can determine.}
...
The Bekenstein--Hawking entropy of the cosmological horizon is independently $S_{\text{dS}} \sim 10^{122}$~\cite{tHooft1993,GibbonsHawking1977}. The hidden-sector dimensionality is therefore:
\begin{equation}
    N \sim S_{\text{dS}}^{\,2}
\end{equation}
...
\textbf{5.2 Stochastic Gravitational Noise Floor (future detectors).} Since gravity is the mean of a high-variance distribution, it should exhibit statistical fluctuations at high frequencies: a \textbf{stochastic gravitational wave background} in the MHz--GHz band~\cite{ArvanitakiGeraci2013}, with an inverse-frequency-squared spectrum. The amplitude is anchored to the $10^{122}$ ratio and is falsifiable.
...
The argument connects: Wolpert's inference impossibility~\cite{Wolpert2008} as the mathematical foundation, Sorkin's causal-set prediction~\cite{Ahmed2004} as independent confirmation of $\Lambda \sim N^{-1/2}$, and---as a conjectured extension (\S4)---the Barandes stochastic-quantum correspondence~\cite{Barandes2023,Barandes2025} via the Nakajima--Zwanzig trace-out as a potential mechanism by which the quantum projection produces specifically quantum-mechanical statistics. The conjecture is supported by three independent physical constraints on the hidden sector (\S4.3) and admits a precise falsification criterion via temporal Tsirelson's bound~\cite{Le2017}. The result is compatible with but distinct from Bohr's complementarity~\cite{Bohr1935}, 't Hooft's deterministic quantum mechanics~\cite{tHooftCA2016}, and emergent gravity programmes~\cite{Verlinde2011,Jacobson1995} (we do not derive gravity, but identify why the gravitational and quantum descriptions cannot agree). The closest precedent is Padmanabhan~\cite{Padmanabhan2005,PadmanabhanPadmanabhan2017}, whose variance-mean distinction is adapted and rigorously grounded in Wolpert's bounds here.
...
\textbf{On the Trace-Out Conjecture.} (4) Prove that CP-divisibility is incompatible with the joint constraints of maximal trans-horizon entanglement, fast-scrambling dynamics ($t_s \sim \log S_{\text{dS}}$), and macroscopic conservation laws---or equivalently, that the Nakajima--Zwanzig trace-out under these constraints produces dynamics violating temporal Tsirelson's bound~\cite{Le2017}; (5) whether the Barandes--Hasan--Kagan derivation of the Tsirelson bound~\cite{BarandesHasanKagan2025} extends from the CHSH inequality to all Bell-type inequalities; (6) whether the spectral statistics of fast-scrambling Hamiltonians~\cite{SekinoSusskind2008} are formally incompatible with the algebraic conditions for CP-divisibility~\cite{CaroGraswald2021}.
...
If correct, the incompatibility between quantum mechanics and gravity is not a bug to be fixed. It is the physical analogue of G\"{o}del incompleteness~\cite{Godel1931}---the universe telling observers, in the starkest numerical terms available, that they are inside the system they are trying to describe.
...
\bibitem{Bohr1935}
N. Bohr, ``Can Quantum-Mechanical Description of Physical Reality Be Considered Complete?'' \textit{Phys.\ Rev.}\ \textbf{48}, 696--702 (1935).

\bibitem{tHooftCA2016}
G. 't Hooft, \textit{The Cellular Automaton Interpretation of Quantum Mechanics} (Springer, 2016).

\bibitem{Verlinde2011}
E. P. Verlinde, ``On the Origin of Gravity and the Laws of Newton,'' \textit{JHEP}\ \textbf{2011}, 29 (2011). arXiv:1001.0785.

\bibitem{Jacobson1995}
T. Jacobson, ``Thermodynamics of Spacetime: The Einstein Equation of State,'' \textit{Phys.\ Rev.\ Lett.}\ \textbf{75}, 1260 (1995). arXiv:gr-qc/9504004.
...
\bibitem{Ahmed2004}
M. Ahmed, S. Dodelson, P. B. Greene, and R. Sorkin, ``Everpresent $\Lambda$,'' \textit{Phys.\ Rev.\ D}\ \textbf{69}, 103523 (2004). arXiv:astro-ph/0209274.
...
T. Padmanabhan, ``Vacuum Fluctuations of Energy Density can lead to the observed Cosmological Constant,'' \textit{Class.\ Quantum Grav.}\ \textbf{22}, L107--L110 (2005). arXiv:hep-th/0406060.

\bibitem{PadmanabhanPadmanabhan2017}
T. Padmanabhan and H. Padmanabhan, ``Cosmic Information, the Cosmological Constant and the Amplitude of primordial perturbations,'' \textit{Phys.\ Lett.\ B}\ \textbf{773}, 81--85 (2017). arXiv:1703.06144.

\bibitem{Bell1964}
J. S. Bell, ``On the Einstein Podolsky Rosen paradox,'' \textit{Physics Physique Fizika}\ \textbf{1}, 195--200 (1964).

\bibitem{Nakajima1958}
S. Nakajima, ``On Quantum Theory of Transport Phenomena: Steady Diffusion,'' \textit{Prog.\ Theor.\ Phys.}\ \textbf{20}, 948--959 (1958).

\bibitem{Zwanzig1960}
R. Zwanzig, ``Ensemble Method in the Theory of Irreversibility,'' \textit{J.\ Chem.\ Phys.}\ \textbf{33}, 1338--1341 (1960).

\bibitem{Barandes2023}
J. A. Barandes, ``The Stochastic-Quantum Theorem,'' arXiv:2309.03085 (2023).

\bibitem{Barandes2025}
J. A. Barandes, ``The Stochastic-Quantum Correspondence,'' \textit{Philosophy of Physics}\ \textbf{3}(1):8 (2025).

\bibitem{Almheiri2015}
A. Almheiri, X. Dong, and D. Harlow, ``Bulk Locality and Quantum Error Correction in AdS/CFT,'' \textit{JHEP}\ \textbf{2015}, 163 (2015). arXiv:1411.7041.
...
\bibitem{Le2017}
T. Le, F. A. Pollock, T. Paterek, M. Paternostro, and K. Modi, ``Divisible quantum dynamics satisfies temporal Tsirelson's bound,'' \textit{J.\ Phys.\ A}\ \textbf{50}, 055302 (2017). arXiv:1510.04425.
...
\bibitem{CaroGraswald2021}
M. C. Caro and B. Graswald, ``Necessary Criteria for Markovian Divisibility of Linear Maps,'' \textit{J.\ Math.\ Phys.}\ \textbf{62}, 042203 (2021).

\bibitem{Unruh1976}
W. G. Unruh, ``Notes on black-hole evaporation,'' \textit{Phys.\ Rev.\ D}\ \textbf{14}, 870 (1976).

\bibitem{SekinoSusskind2008}
Y. Sekino and L. Susskind, ``Fast Scramblers,'' \textit{JHEP}\ \textbf{10} (2008) 065. arXiv:0808.2096.
