...
\fancyhf{}
\rhead{\thepage}
\lhead{\textit{The Incompleteness of Observation}}
...
\begin{center}
    {\LARGE\bfseries THE INCOMPLETENESS OF OBSERVATION}\\[0.8em]
    {\large Why Quantum Mechanics and General Relativity\\Cannot Be Unified From Within}\\[1.5em]
    {\large Alex Maybaum}\\[0.5em]
    February 2026\\[0.3em]
    \textsc{Draft Pre-Print}\\[0.3em]
    \textit{Theoretical Physics / Foundations}
\end{center}
