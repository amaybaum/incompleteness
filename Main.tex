...
\subsubsection{9.3 The Stochastic-Quantum Bridge}\label{the-stochastic-quantum-bridge}}
...
\subsubsection{9.5 Vacuum Energy: Relative Effects and the Higgs Potential}\label{vacuum-energy-relative-effects-and-the-higgs-potential}}
