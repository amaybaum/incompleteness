...
The framework's broader metaphysical stance --- ontic structural realism
applied to the equivalence class
\([(S, \varphi)]/\mathcal{G}_{\text{sub}}\), with the wave function,
Hilbert space, and emergent gauge structure understood as features of
representations rather than of the structural object itself --- is
developed in {[}Substratum, §§1.1, 6.1{]}.
