...
\textbf{Observational predictions.} (i) Dark matter ``mass'' within radius \(r\) is determined entirely by enclosed baryonic mass and \(H\) --- no halo-specific parameters. (ii) The effect depends on \(H(z)\): dark matter phenomenology at high redshift differs systematically from low-redshift observations. (iii) The Tully-Fisher relation evolves: \(v^4 \propto H(z)\).

\textbf{Falsifiability.} The entropy displacement account would be falsified by: (a) detection of dark matter particles accounting for \textasciitilde27\% of \(\rho_{\text{crit}}\); (b) high-redshift rotation curves inconsistent with the predicted \(H(z)\) dependence; (c) baryonic Tully-Fisher violations exceeding baryonic mass uncertainties.
